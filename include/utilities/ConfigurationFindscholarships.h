#ifndef ___CONFIGURATION_FINDSCHOLARSHIPS_H___
#define ___CONFIGURATION_FINDSCHOLARSHIPS_H___
...
// singleton pattern
class ConfigurationFindscholarships : public ::ConfigurationBase
{
public:
    static ConfigurationFindscholarships* instance();
...
private:
    ...
    static ConfigurationFindscholarships* _instance;
};
    
} // namespace findscholarships

#endif // ___CONFIGURATION_FINDSCHOLARSHIPS_H___
